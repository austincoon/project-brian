...
const MAX_STEPS = 180;
const REPLAY_SEEDS = {
  "1-1": 16, "1-2": 18, "1-3": 39, "1-4": 132, "1-5": 14, "1-6": 41,
  "2-1": 52, "2-2": 47, "2-3": 32, "2-4": 23, "2-5": 35, "2-6": 12,
  "3-1": 3, "3-2": 77, "3-3": 38, "3-4": 17, "3-5": 22, "3-6": 48,
  "4-1": 75, "4-2": 2, "4-3": 28, "4-4": 25, "4-5": 117, "4-6": 9,
  "5-1": 11, "5-2": 1, "5-3": 7, "5-4": 71, "5-5": 15, "5-6": 6,
  "6-1": 10, "6-2": 8, "6-3": 33, "6-4": 57, "6-5": 45, "6-6": 5,
};
...
export function createDiceSimulation(seed) {
  ...
  const bodies = [0, 1].map((index) => {
    ...
    body.position.set((index ? 1.45 : -1.6) + (random() - 0.5) * 0.6, 4 + index, TRAY_DEPTH / 2 - 2.2 - index * 0.8);
    body.velocity.set((index ? -2.2 : 2.5) + random() - 0.5, random() * 2, -8.5 + (random() - 0.5) * 1.5);
